    ...
    render() {
        ...
        return (
            <div className="both-centered">
                ...
                <CssTextField id="outlined-basic" style = {{width: '40%'}}color="#DEEEEA" label="Email" variant="outlined" type="email" required onChange={onChange('email')} InputLabelProps={{style: {color: '#DEEEEA'}}}/>
