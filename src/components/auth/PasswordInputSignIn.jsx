    ...
    render() {
        ...
        return (
            <div className="both-centered">
                ...
                <CssTextField id="outlined-basic" color="#DEEEEA" label="Password" variant="outlined" type="password" required onChange={onChange('password')} InputLabelProps={{style: { color: '#DEEEEA' },}} />
                <Grid container spacing={24} direction="row" justifyContent='center' alignItems="center" >
                    ...
                    <Button variant="contained" color="primary" onClick={onLogin}>NEXT</Button>
                </Grid>                 
                {
